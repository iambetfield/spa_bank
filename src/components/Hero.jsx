  ...
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    ...
    >
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eos omnis quo
        autem blanditiis corrupti odit, nam assumenda eveniet, repellendus eum
        dolore alias natus.
      </p>
    </div>
    {/* Div para el lado derecho */}
    <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
      <img src={robot} alt="billing" className="w-[100%] h-[100%] relative z-[5]" />
      {/* <div className="absolute z-[0] w-[40%] h-[35%] top-0 pink__gradient "/>
      <div className="absolute z-[1] w-[80%] h-[85%] rounded bottom-40 white__gradient "/>
